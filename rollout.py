...
def env_creator(env_config):
    return CarlaEnv()  # return an env instance

register_env("carla_v0", env_creator)
...
# python rollout.py /home/gu/ray_results/carla/PPO_CarlaEnv_0_2019-02-26_15-31-5836jqj81a/checkpoint_1/checkpoint-1 --run PPO --env carla_v0
