...
if __name__ == '__main__':
    ...
    parser.add_argument('--hid', type=list, default=[600, 256, 32])
    parser.add_argument('--gamma', type=float, default=0.99)
    parser.add_argument('--seed', '-s', type=int, default=0)
    parser.add_argument('--epochs', type=int, default=1000)
    parser.add_argument('--exp_name', type=str, default='sac_carla_large_again')
    ...
    sac(env_fn, actor_critic=core.mlp_actor_critic,
