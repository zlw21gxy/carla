...
def plot_image_rows_mnist(images_list, title_list):
    rows = len(images_list)
...
def plot_laplacian_variances(lvs_1, lvs_2, lvs_3, title):
    ...
    print("orginal", "min:", min(lvs_1), "max:", max(lvs_1), "mean", np.mean(np.array(lvs_1)))
    print("vae", "min", min(lvs_3), "max", max(lvs_3), "mean", np.mean(np.array(lvs_3)))
    # print("VAE", lvs_3.min(), lvs_3.max(), lvs_3.mean())
